...
import MyBtn from '@/_builder/components/custom/CustomBtn.vue';
import MyTextBox from '@/_builder/components/custom/CustomTextBox.vue';
// import MyDiv from '@/_builder/components/custom/CustomDiv.vue';
// import MySpan from '@/_builder/components/custom/CustomSpan.vue';
...
export const ComponentRegistry: any = {
  ...
  'my-autocomplete': {
    ...
    propsMeta: [
      ...
      // { key: 'item-title', label: 'item-title', type: 'text' },
      // { key: 'item-value', label: 'item-value', type: 'text' },
      { key: 'label', label: 'label', type: 'text' },
      // { key: 'max-width', label: 'max-width', type: 'text' },
      // { key: 'min-width', label: 'min-width', type: 'text' },
